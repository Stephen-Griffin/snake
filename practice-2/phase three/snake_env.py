...
class SnakeGameEnv:
    ...
    def get_state(self):
        ...
        body_collision = int(point_s in self.snake_body[1:])

        bits = [
            danger_straight, danger_right, danger_left, body_collision,
        ...
        # finally pack all bits into a single integer:
        state = 0
        for b in bits:
            state = (state << 1) | b
        return state
