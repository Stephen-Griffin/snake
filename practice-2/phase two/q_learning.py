...
class QLearning:
    def __init__(self, n_states, n_actions, alpha=0, gamma=0.99, epsilon=0, epsilon_min=0.01, epsilon_decay=0.995):
    ...
    def save_q_table(self, filename="phase two/q_table.txt"):
        np.savetxt(filename, self.q_table)

    def load_q_table(self, filename="phase two/q_table.txt"):
        try:
